...
export const TEMPLATE_VARIABLES: TemplateVariable[] = [
  ...
  {
    token: "job.areas",
    label: "Rooms in the last job",
    example: "hallway and stairwell",
    source: "Named areas on the completion record. Absent when none were logged.",
  },
  {
    token: "job.workType",
    label: "Work type",
    example: "interior",
    source: "Interior, exterior or industrial, read off the completion record.",
  },
  {
    token: "promo.label",
    label: "Offer name",
    example: "spring interior",
    source: "The promo attached to the deal, without the discount.",
  },
  {
    token: "promo.sentWhen",
    label: "When the offer went out",
    example: "Monday",
    source: "The send date, as a person would say it.",
  },
  {
    token: "promo.slot",
    label: "Slot we can hold",
    example: "Thursday",
    source: "The next weekday an estimator could attend.",
  },
  {
    token: "loss.value",
    label: "Original quote",
    example: "$5,600",
    source: "What we quoted on a deal that was lost on price.",
  },
  {
    token: "loss.month",
    label: "When we quoted",
    example: "January",
    source: "The month the lost quote went out.",
  },
  {
    token: "loss.scope",
    label: "Scope that was quoted",
    example: "exterior repaint",
    source: "The work the lost quote covered.",
  },
  {
    token: "season",
    label: "Current season",
    example: "winter",
    source: "Derived from today's date, for schedule availability.",
  },
  {
    token: "prospect.firstName",
    label: "Prospect first name",
    example: "Desmond",
    source: "The Biz Dev contact.",
  },
  {
    token: "prospect.company",
    label: "Prospect company",
    example: "Northgate",
    source: "Their company, shortened for mid-sentence use.",
  },
  {
    token: "reference.proof",
    label: "Reference we can name",
    example: "Vantage Construction Group sites",
    source: "An adjacent active account, for a cold intro.",
  },
  {
    token: "neighbour.proximity",
    label: "How close the neighbour is",
    example: "two doors down to you",
    source: "Recorded on the canvass target. Absent when not noted.",
  },
  {
    token: "crew.until",
    label: "Crew on site until",
    example: "Friday",
    source: "How long the crew is still in the street.",
  },
  {
    token: "enquiry.subject",
    label: "What the enquiry was about",
    example: "interior work",
    source:
      "The captured scope, or a general phrase when none was — always available, so a template using it is never ineligible for want of a scope.",
  },
  {
    token: "enquiry.month",
    label: "Enquiry month",
    example: "back in June last year",
